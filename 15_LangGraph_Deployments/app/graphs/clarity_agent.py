...
After the agent responds, a secondary node evaluates whether the answer is clear.
If clear, end; otherwise, continue the loop or terminate after a safe limit.
"""
...
class ClarityResult(BaseModel):
    is_clear: bool = Field(description="Whether the response is clear, easy to understand, and well-structured")
...
_clarity_prompt = ChatPromptTemplate.from_template(
    ...
    "is clear, easy to understand, and well-structured.\n\n"
    "Initial Query:\n{initial_query}\n\n"
    "Final Response:\n{final_response}"
)
...
def build_graph():
    """Build an agent graph with an auxiliary clarity evaluation subgraph."""
